...
import com.wr15.redhunter.presenter.HistoryBarangUserPresenter
...
class HistoryInventoryBarangFragmentUser: Fragment(),
    HistoryBarangUserPresenter.HistoryFileView,
    SearchView.OnQueryTextListener {

    private val apiServices by lazy { RetrofitBuilder.builder().create(ApiServices::class.java) }
    private val presenter by lazy { HistoryBarangUserPresenter(apiServices, this) }
