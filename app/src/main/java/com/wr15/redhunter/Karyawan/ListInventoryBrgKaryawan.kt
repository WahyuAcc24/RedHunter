...
class ListInventoryBrgKaryawan : Fragment() {


    private lateinit var lstHistoribrg: RecyclerView

    var urlbrg = ServerHost.url + "list_inventory_brg.php?id_user= " + Rak.grab("iduser")
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.history_inventory_karyawan, container, false)
//        bn_main.setOnNavigationItemSelectedListener(mOnNavigationItemSelectedListener)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lstHistoribrg = view.findViewById(R.id.rvListinventorykaryawan) as RecyclerView

        pglistbrg = view.findViewById(R.id.progressBarinventorykaryawan) as ProgressBar

        swipeRefreshLayout = view.findViewById(R.id.swipehistoryinventorykaryawan)
        ...
        override fun onResponse(response:String) {
            ...
            if (orderCek!!.isStatus){
                try {
                    ...
                    adapterfile = HistoryInventoryAdapter(orderCek.dataBarang)

                    adapterfile!!.setListener(object: ItemClickListener<MFile> {
                        override fun onClicked(Barang: MFile?, position: Int, view: View?) {

                            val intent = Intent(context, DetailInventoryKaryawan::class.java)
