...
class HistoryPengajuanBarangFragmentUser: Fragment(),
    HistoryPengajuanUserPresenter.HistoryPengajuanView,
    SearchView.OnQueryTextListener {

    private val apiServices by lazy { RetrofitBuilder.builder().create(ApiServices::class.java) }
    private val presenter by lazy { HistoryPengajuanUserPresenter(apiServices, this) }
