...
class DetailHistoryUser : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.detail_userdev_main)


        txt_nama =  findViewById(R.id.txtnamauserdetail)
        txt_divisi = findViewById(R.id.txtdivisiuserdetail)
        txt_jk =  findViewById(R.id.txtjkuserdetail)
        ...
        swipeRefreshLayout = findViewById(R.id.swipedetailhistoryuser)
    ...
    fun hapusUser(id_user:String){
        ...
        val stringRequest = object : StringRequest(
            ...
            Response.Listener<String> { response ->
                ...
                val intent = Intent(this@DetailHistoryUser,
