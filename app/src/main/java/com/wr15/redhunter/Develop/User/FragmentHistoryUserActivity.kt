...
class FragmentHistoryUserActivity : Fragment(),
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        swipeRefreshLayout = view.findViewById(R.id.swipehistoryuser)
    ...
    override fun onGoodsListUser(result: UserStatus<MUser>) {
        ...
        if (result.isStatus) {
            ...
            adapter.setListener { user, _, _ ->
                val intent = Intent(context, DetailHistoryUser::class.java)
