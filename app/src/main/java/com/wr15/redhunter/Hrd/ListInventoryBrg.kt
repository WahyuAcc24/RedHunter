...
class ListInventoryBrg : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.history_inventory, container, false)
//        bn_main.setOnNavigationItemSelectedListener(mOnNavigationItemSelectedListener)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lstHistoribrg = view.findViewById(R.id.rvListinventory) as RecyclerView

        pglistbrg = view.findViewById(R.id.progressBarinventory) as ProgressBar
