...
class RekapTrainerActivity : AppCompatActivity() {
            ...
            Response.Listener<String> { response ->
                ...
                try {
                    ...
                    Log.e(TAG, "Login Response: $response")
                        ...
                        var tablejumlah = PdfPTable(7)
                        tablejumlah.setWidthPercentage(100F)
                        tablejumlah.setWidths(floatArrayOf(15f, 30f, 20f, 30f, 30f, 30f, 30f))
                    ...
                    var jmlh1 = PdfPCell(Paragraph(total.toString(), fontnormalcolorwhite))
                    jmlh1.setHorizontalAlignment(Element.ALIGN_CENTER)
                    jmlh1.setBackgroundColor(BaseColor.BLUE)

                    var jmlh2 = PdfPCell(Paragraph(total.toString(), fontnormalcolorwhite))
