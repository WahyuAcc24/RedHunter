...
class ListInventoryBrgCeo : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.history_inventory_ceo, container, false)
//        bn_main.setOnNavigationItemSelectedListener(mOnNavigationItemSelectedListener)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lstHistoribrg = view.findViewById(R.id.rvListinventoryceo) as RecyclerView

        pglistbrg = view.findViewById(R.id.progressBarinventoryceo) as ProgressBar
