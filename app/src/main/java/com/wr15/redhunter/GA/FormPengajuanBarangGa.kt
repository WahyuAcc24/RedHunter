...
class FormPengajuanBarangGa : AppCompatActivity(){
    ...
    private val TAG = FormPengajuanBarangGa::class.java.getSimpleName()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_barang.setOnClickListener {
            ...
            val id_user = Rak.grab("idga") as String
            val nama_user = Rak.grab("namaga") as String
            val divisi = Rak.grab("divisiga") as String
    ...
    private fun cekBrg(id_user : String,nama_user : String, divisi:String ,nama_brg:String, satuan_brg:String, harga_brg:String, jumlah_brg:String, alasan : String){
        ...
        val stringRequest = object : StringRequest(
            ...
            Response.Listener<String> { response ->
                ...
                val intent = Intent(this@FormPengajuanBarangGa,
